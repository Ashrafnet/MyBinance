...
namespace Office2007Renderer
{
    ...
    public class Office2007ColorTable : ProfessionalColorTable
    {
        ...
        private static Color _overflowEnd = Color.FromArgb(164, 195, 235);
        private static Color _overflowMiddle = Color.FromArgb(167, 204, 251);
        private static Color _menuToolBack = Color.FromArgb(17,118, 255);
        ...
        private static Color _toolStripContentEnd = Color.FromArgb(164, 195, 235);//164, 195, 235
        private static Color _toolStripBegin = Color.FromArgb(164, 195, 235);//227, 239, 255
        private static Color _toolStripEnd = Color.FromArgb(164, 195, 235);
    ...
    public class Office2007ColorTableBlue : ProfessionalColorTable
    {
        #region Static Fixed Colors - Blue Color Scheme
        private static Color _contextMenuBack = Color.FromArgb(250, 250, 250);
        private static Color _buttonPressedBegin = Color.FromArgb(248, 181, 106);
        ...
        /// Initialize a new instance of the Office2007ColorTable class.
        /// </summary>
        public Office2007ColorTableBlue()
        {
        }
        #endregion
